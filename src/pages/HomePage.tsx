...
import { getFeaturedProducts, getProducts } from '../utils/dataAdapter'
...
const madeToOrderProducts = getProducts().filter((product) => product.status === 'made-to-order').slice(0, 2)
